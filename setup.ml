...
(* OASIS_START *)
(* DO NOT EDIT (digest: be5604be8fb7d92ab3b33094885c91e6) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers =
            ["Micha\197\130 Kurcewicz <michal.kurcewicz@gmail.com>"];
          authors = ["Micha\197\130 Kurcewicz <michal.kurcewicz@gmail.com>"];
     ...
     oasis_digest = Some "wN\229\230\017\246\217z!\018U;\021p\"\003";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
