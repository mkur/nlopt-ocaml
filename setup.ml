...
let setup_t =
  {
     ...
     test = [];
     doc = [("nlopt", OCamlbuildDocPlugin.doc_build ".")];
     install = InternalInstallPlugin.install;
     uninstall = InternalInstallPlugin.uninstall;
     clean = [OCamlbuildPlugin.clean];
     clean_test = [];
     clean_doc = [("nlopt", OCamlbuildDocPlugin.doc_clean ".")];
     distclean = [];
     distclean_test = [];
     distclean_doc = [];
     package =
       {
          ...
          license_file = None;
          copyrights = [];
          maintainers = ["MichaÅ\130 Kurcewicz <michal.kurcewicz@gmail.com>"];
          authors = ["MichaÅ\130 Kurcewicz <michal.kurcewicz@gmail.com>"];
          homepage = Some "https://bitbucket.org/mkur/nlopt-ocaml";
          synopsis =
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_c_sources = ["nlopt_wrapper.c"];
                      bs_data_files = [];
                      bs_ccopt =
                        [(OASISExpr.EBool true, ["-std=c99"; "-O3"; "-Wall"])
                        ];
                      bs_cclib = [(OASISExpr.EBool true, ["-lnlopt"])];
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_title = "API reference for NLOpt";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "ÔÄ\152÷Pp®gThûo\139_-ò";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
