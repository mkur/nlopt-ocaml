...
let setup_t =
  {
     ...
     package =
       {
          ...
          license_file = None;
          copyrights = [];
          maintainers = ["Micha≈\130 Kurcewicz <michal.kurcewicz@gmail.com>"];
          authors = ["Micha≈\130 Kurcewicz <michal.kurcewicz@gmail.com>"];
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "≥\153…Õ\132g\155∑\023ld∆\030\155\022Ø";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
